...
public class Desenhos {
    ...
    public static void incluir(Desenho desenho, String idUsuario) throws Exception {
        if (desenho == null)
        ...
        try {
            ...
            sql = "INSERT INTO Desenhos " + "(nome,idUsuario,dataCriacao,dataUltimaAtualizacao,conteudo) " + "VALUES "
                    + "(?,?,?,?,?)";

            BDSQLServer.COMANDO.prepareStatement(sql);

            BDSQLServer.COMANDO.setString(1, desenho.getNome());
            BDSQLServer.COMANDO.setString(2, idUsuario);
            BDSQLServer.COMANDO.setString(3, desenho.getDataCriacao());
            BDSQLServer.COMANDO.setString(4, desenho.getDataUltimaAtualizacao());
            BDSQLServer.COMANDO.setString(5, desenho.toString());
    ...
    public static void alterar(Desenho desenho) throws Exception {
        ...
        try {
            ...
            BDSQLServer.COMANDO.setString(2, desenho.toString());
    ...
    public static Desenho getDesenho(String idUsuario) throws Exception {
        Desenho desenho = null;

        try {
            String sql;

            sql = "SELECT * " + "FROM Desenho " + "WHERE idUsuario = ?";

            BDSQLServer.COMANDO.prepareStatement(sql);

            BDSQLServer.COMANDO.setString(1, idUsuario);
    ...
    public static MeuResultSet getDesenhos(String idUsuario) throws Exception {
